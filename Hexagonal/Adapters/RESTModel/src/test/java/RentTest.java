...
public class RentTest {
    ...
    void testRent() {
        ...
        Assertions.assertEquals("Rent{client=User{firstName='null', surname='null', username='null', emailAddress='null', role=null, active=false}::Client{clientType=null, currentRents=0}, vMachine=AppleArch: RESTMongoUUID{uuid=11111111-1111-1111-1111-111111111111} 24 128GB 0 0.0, beginTime=2025-01-01T01:01, endTime=2025-01-01T01:01, rentCost=0.0}", rent.toString());
        Assertions.assertEquals("Rent{client=User{firstName='null', surname='null', username='null', emailAddress='null', role=null, active=false}::Client{clientType=null, currentRents=0}, vMachine=AppleArch: RESTMongoUUID{uuid=11111111-1111-1111-1111-111111111111} 24 128GB 0 0.0, beginTime=2025-01-01T01:01, endTime=null, rentCost=0.0}", rent3.toString());
